...
public:
    ...
    static std::unique_ptr<Connection> connectToSocket(const char* hostname, const char* port);
    ...
    bool sendFile(const std::string& file_name) override;
    bool receiveFile(std::string file_name, size_t file_size) override;
